...
/**
 * Miroir de `app/.../ui/theme/TerminalThemesTest.kt` : les présélections sont
 * dupliquées dans les deux modules, les garde-fous le sont donc aussi.
 * Écrit avec kotlin.test comme le reste du module, qui tourne sous JUnit 4.
 */
